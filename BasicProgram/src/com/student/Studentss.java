...
public class Studentss {
	...
	int[] marks;
		...
		public Studentss() {
//	    System.out.println("First you enter subject marks :" );
		// TODO Auto-generated constructor stub
	}

	//Constructor
	public Studentss(int id, String name, int[] marks) {
		super();
		this.id = id;
		this.name = name;
		this.marks = marks;
	...
	public static void main(String[] args) {
		...
		Studentss[] students = new Studentss[batchSize];
		...
		for(int i= 0 ; i<students.length ; i++)
		{
			...
			students[i] = new Studentss(id,name,marks);
		}
